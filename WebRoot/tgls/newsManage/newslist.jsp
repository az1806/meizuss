<%@ page language="java" import="java.util.*,com.jiaju.entity.*, java.text.SimpleDateFormat,java.util.Date;"
	pageEncoding="utf-8"%>
<%
	...
	<div class="cBody">
		...
		<table class="layui-table" id="customList">
			...
			<tbody>
				...
				<tr>
					...
					<td>	
						<button onclick="del()" class="layui-btn layui-btn-xs"    data-id="<%=newslist.get(i).getNewsid() %>">删除</button>
						<button onclick="updateBut()" class="layui-btn layui-btn-xs">修改</button></td>                   
				</tr>
				<%
					}
				%>
		...
		<div class="cBody">
			...
			<form>
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						<button class="layui-btn" lay-submit lay-filter="submitBut"
