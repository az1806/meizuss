...
<div class="cBody">
	<table>
		<thead>
			<tr>
				<td>序号</td>
				<td><input value="<%=com.getCompanyid()%>" id="companyid">
				</td>
			</tr>
			<tr>
				<td>公司名称</td>
				<td><input value="<%=com.getCompanyname()%>" id="companyname">
				</td>
			</tr>
			<tr>
				<td>公司首页介绍</td>
				<td><textarea rows="5" cols="50" id="syjs"><%=com.getSyjs()%></textarea>
			...
			<tr>
				<td>关于公司介绍</td>
				<td><textarea rows="5" cols="50" id="gyjs"><%=com.getGyjs()%></textarea>
			...
			<tr>
				<td>公司文化</td>
				<td><textarea rows="5" cols="50" id="culture"><%=com.getCulture()%></textarea>
				</td>
			</tr>
			<tr>
				<td>地址</td>
				<td><input value="<%=com.getAddress()%>" id="address">
				</td>
			</tr>
			<tr>
				<td>电子邮箱</td>
			...
			<tr>
				<td>公司图片</td>
				<td><input value="<%=com.getImgzong()%>" id="imgzong">
		
			<div style="border:1px solid black;" 
			><img alt="" src="<%=com.getImgzong()%>" width="200px"></div>
				</td>
			...
			<tr>
				...
				<td>
					...
					<input type="button" onclick="updateCompany()" value="修改"
					class="layui-btn layui-btn-xs"></td>
              ...
              <tr>
              <td> 商品名字：<input type="text" id="productname" name="dname" /><br /> 图片：<img
					id="imgFace" style="width:120px" /><br /> <input type="file"
					name="file" class="layui-upload-file" /> <br />
				<button type="button" class="layui-btn" id="test1">上传图片</button></td>
