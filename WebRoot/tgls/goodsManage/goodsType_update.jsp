...
ProductClass pc=(ProductClass) request.getAttribute("pc");
  ...
  <head>
	...
	--><meta charset="UTF-8">
		...
		<script type="text/javascript">
		  ...
		  window.location.href="adminproducttype?method=update&typeid="+typeid+"&typename="+typename+"";
			}
			...
			<form >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" id="name" value="<%=pc.getTypename() %>"  required lay-verify="required" autocomplete="off" class="layui-input">
					</div>
				</div>
